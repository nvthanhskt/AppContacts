...
public class Adapter_YeuThich extends RecyclerView.Adapter<Adapter_YeuThich.viewHolder>{
        Context mycontext;
        List<DanhBa> list;

public  Adapter_YeuThich(Context mycontext, List<DanhBa> list) {
...
class viewHolder extends RecyclerView.ViewHolder {
    ...
    @NonNull
    @Override
    public Adapter_YeuThich.viewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        LayoutInflater inflater = LayoutInflater.from(mycontext);
        View view = inflater.inflate(R.layout.danhba_item, null, false);
        Adapter_YeuThich.viewHolder v = new  Adapter_YeuThich.viewHolder(view);

        return v;
    }

    @Override
    public void onBindViewHolder(@NonNull final Adapter_YeuThich.viewHolder viewHolder, int i) {
        final int posi = i;
        ...
        viewHolder.menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                pmenu.getMenuInflater().inflate(R.menu.yeu_thich_menu,pmenu.getMenu());
        ...
        new AlertDialog.Builder(mycontext)
                ...
                .setNegativeButton("Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        new DataBase(mycontext).xoa_yeuthich(list.get(i).getId());
                        list.remove(i);
