...
public class Adapter_LienLacTheoNhom extends RecyclerView.Adapter<Adapter_LienLacTheoNhom.viewHolder>{
    Context mycontext;
    List<DanhBa> list;

    public  Adapter_LienLacTheoNhom(Context mycontext, List<DanhBa> list) {
    ...
    @NonNull
    @Override
    public Adapter_LienLacTheoNhom.viewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        LayoutInflater inflater = LayoutInflater.from(mycontext);
        View view = inflater.inflate(R.layout.danhba_item, null, false);
        Adapter_LienLacTheoNhom.viewHolder v = new  Adapter_LienLacTheoNhom.viewHolder(view);

        return v;
    }

    @Override
    public void onBindViewHolder(@NonNull final Adapter_LienLacTheoNhom.viewHolder viewHolder, int i) {
        final int posi = i;
        ...
        viewHolder.menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                pmenu.getMenuInflater().inflate(R.menu.menu_list_group,pmenu.getMenu());
    ...
    private void deleteGR(final int i){
        new AlertDialog.Builder(mycontext)
                .setMessage("Bạn chắc chắn muốn xóa "+list.get(i).getTen()+ " khỏi nhóm ?")
                .setTitle("Cảnh báo")
                .setNegativeButton("Ok", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        new DataBase(mycontext).sua_nhomLL("",list.get(i).getId());
                        list.remove(i);
